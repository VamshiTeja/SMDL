...
if __name__ == '__main__':
    ...
    for i in range(1, 41):
        try:
            test_data = [[
                                  '/home/vamshi/PycharmProjects/SMDL/output/cifar10_resnet20_random_full_0119_214639/accuracies/test_acc_between_iteration_epoch_' + str(i) + '_accuracy.pkl',
                                  'Random Selection', 'blue'],
                              [
                                  '/home/vamshi/PycharmProjects/SMDL/output/cifar10_resnet20_submod_comb_0128_211805/accuracies/test_acc_between_iteration_epoch_' + str(i) + '_accuracy.pkl',
                                  'Submodular Selection', 'green']
                              ]
            plot_accuracies(test_data, title='CIFAR10 Epoch ' + str(i) + ' Test Accuracy', x_axis_label='# of iterations (x10)')
